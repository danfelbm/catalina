...
return [
    ...
    */
    ...
    'custom' => [
        'candidatura_id' => [
            'required' => 'Debes seleccionar tu perfil de candidatura.',
            'exists' => 'El perfil de candidatura seleccionado no es válido.',
        ],
        'attribute-name' => [
    ...
    | marcador de posición de atributo con algo más fácil de leer para el usuario,
    ...
    */
    ...
    'attributes' => [
        ...
        'password' => 'contraseña',
        'name' => 'nombre',
        'candidatura_id' => 'perfil de candidatura',
        'formulario_data' => 'datos del formulario',
    ],
