...
const form = useForm({
    ...
    configuracion_campos: [] as FormField[],
    configuracion_general: {},
    tipo_acceso: 'autenticado',
    permite_visitantes: false,
    requiere_captcha: true,
    fecha_inicio: null as string | null,
    fecha_fin: null as string | null,
    limite_respuestas: null as number | null,
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="p-6">
            ...
            <div class="mb-6 flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold">Crear Formulario</h1>
                    <p class="text-muted-foreground">
                        Configura un nuevo formulario dinámico
                    </p>
                </div>
